							...
							<div class="splide__track">
								<ul class="splide__list">
									<li class="splide__slide">
										<img src="img/cars/1-1-big.jpg" alt="">
									</li>
									<li class="splide__slide">
										<img src="img/cars/1-2-big.jpg" alt="">
									</li>
									<li class="splide__slide">
										<img src="img/cars/1-3-big.jpg" alt="">
									</li>
									<li class="splide__slide">
										<img src="img/cars/1-4-big.jpg" alt="">
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="offer">
						...
						<ul class="offer__list">
							<li>
								...
								<span class="offer__list-value offer__list-value--dark">$440</span>
							</li>
							<li>
								<span class="offer__list-name">Cash incentive</span>
								<span class="offer__list-value">To be provided by seller</span>
							</li>
							<li>
								<span class="offer__list-name">Transfer fee</span>
								<span class="offer__list-value">To be provided by seller</span>
							</li>
							<li>
							...
							<li>
								<span class="offer__list-name">Leasing company</span>
								<span class="offer__list-value offer__list-value--dark">Toyota Financial Services</span>
							</li>
							<li>
								<span class="offer__list-name">Lease end date</span>
								<span class="offer__list-value offer__list-value--dark">01 Dec 2022</span>
							</li>
						</ul>
			...
			<section class="row">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<a href="cars.html" class="main__link">View more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17.92,11.62a1,1,0,0,0-.21-.33l-5-5a1,1,0,0,0-1.42,1.42L14.59,11H7a1,1,0,0,0,0,2h7.59l-3.3,3.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0l5-5a1,1,0,0,0,.21-.33A1,1,0,0,0,17.92,11.62Z"/></svg></a>
					</div>
				</div>
				<!-- end title -->
				...
				<div class="col-12 col-md-6 col-xl-4">
					<div class="car">
						...
						<div class="car__footer">
							<span class="car__price">$530 <sub>/ month</sub></span>
							<button class="car__favorite" type="button" aria-label="Add to favorite"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.16,5A6.29,6.29,0,0,0,12,4.36a6.27,6.27,0,0,0-8.16,9.48l6.21,6.22a2.78,2.78,0,0,0,3.9,0l6.21-6.22A6.27,6.27,0,0,0,20.16,5Zm-1.41,7.46-6.21,6.21a.76.76,0,0,1-1.08,0L5.25,12.43a4.29,4.29,0,0,1,0-6,4.27,4.27,0,0,1,6,0,1,1,0,0,0,1.42,0,4.27,4.27,0,0,1,6,0A4.29,4.29,0,0,1,18.75,12.43Z"/></svg></button>
							<a href="car.html" class="car__more"><span>Rent now</span></a>
						</div>
					</div>
				...
				<div class="col-12 col-md-6 col-xl-4">
					<div class="car">
						...
						<div class="car__footer">
							<span class="car__price">$490 <sub>/ month</sub></span>
							<button class="car__favorite" type="button" aria-label="Add to favorite"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.16,5A6.29,6.29,0,0,0,12,4.36a6.27,6.27,0,0,0-8.16,9.48l6.21,6.22a2.78,2.78,0,0,0,3.9,0l6.21-6.22A6.27,6.27,0,0,0,20.16,5Zm-1.41,7.46-6.21,6.21a.76.76,0,0,1-1.08,0L5.25,12.43a4.29,4.29,0,0,1,0-6,4.27,4.27,0,0,1,6,0,1,1,0,0,0,1.42,0,4.27,4.27,0,0,1,6,0A4.29,4.29,0,0,1,18.75,12.43Z"/></svg></button>
							<a href="car.html" class="car__more"><span>Rent now</span></a>
						</div>
					</div>
				...
				<div class="modal__content">
					...
					<form action="#" class="modal__form">
						...
						<div class="sign__group">
							...
							<input id="delivery" type="text" name="delivery" class="sign__input" placeholder="221B Baker St, Marylebone, London">

							<span class="sign__text sign__text--left">You can spend money from your account on the renewal of the connected packages, or on the purchase of goods on our website.</span>
						</div>
